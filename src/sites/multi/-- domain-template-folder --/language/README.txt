...
If you want to add a new language set to the Debate Hub you need to:
...
This makes it easy to change the basic terminology for a given Debte Hub instance without editing lots of interface text.
