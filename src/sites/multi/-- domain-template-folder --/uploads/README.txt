...
The 'uploads' folder is where user, group and debate images will be place. 
...
For images added to a Debate, these will be stored inside the folder of the user who created the debate, inside a sub-folder
whose name is the unique id number of the debate. 
